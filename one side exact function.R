# i think i searched for this functino and found this
...
bin1samp(p0=.5, pa=.68, alpha = 0.025, beta = 0.1, n.min = 20)     #81
bin1samp(p0=.5, pa=.68, alpha = 0.025, beta = 0.2, n.min = 20)     #63

bin1samp(p0=.37, pa=.68, alpha = 0.025, beta = 0.1, n.min = 28)     #28
bin1samp(p0=.37, pa=.68, alpha = 0.025, beta = 0.2, n.min = 23)     #23
